...
from models.geocnet import GeoCNet
...
class Runner:
    ...
    def _get_valid_dataset(self):
        ...
        if 'openlane' in args.dataset_name:
            ...
            elif args.evaluate_case=='up_down_case':
                # TODO eval case
                valid_dataset = LaneDataset(args.dataset_dir, args.data_dir + 'test/up_down_case/', args)
            elif args.evaluate_case=='night_case':
                valid_dataset = LaneDataset(args.dataset_dir, args.data_dir + 'test/night_case/', args)
            elif args.evaluate_case=='intersection_case':
                valid_dataset = LaneDataset(args.dataset_dir, args.data_dir + 'test/intersection_case/', args)
            elif args.evaluate_case=='curve_case':
                valid_dataset = LaneDataset(args.dataset_dir, args.data_dir + 'test/curve_case/', args)
            elif args.evaluate_case=='merge_split_case':
                valid_dataset = LaneDataset(args.dataset_dir, args.data_dir + 'test/merge_split_case/', args)
            else:
                valid_dataset = LaneDataset(args.dataset_dir, args.data_dir + 'test/extreme_weather_case/', args)
